        ...
        <q-card flat bordered class="q-ma-md q-pa-lg col-4 /lt-sm	">  <!--  Q-CARD to XS    -->
            <q-card-section>
                <div
                        ...
                        :class="[state]"
                >{{balance}} грн <br> {{getAccess(state)}}
                </div>
                <div
                        class="text-h7"
                ...
                <div class="q-pa-md q-gutter-sm flex flex-center">
                    <q-btn color="primary" class="" icon="attach_money" label="Online - оплата"/>
                    <br/>
                </div>
            </q-card-section>
        </q-card>
...
-->
        ...
        <q-card flat bordered class="my-items-personal-data q-ma-md q-pa-md col-lg">
            ...
            <div class="text-h6">
                ...
                Особовий рахунок: <b>{{contract}}</b></div>
            <div class="text-h6">
            ...
            <div class="text-h6">
                <q-icon name="account_circle"/>
                Ваш тариф: <b>{{p_name.replace("[1000]", "")}}</b></div>
